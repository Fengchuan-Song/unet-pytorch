...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default='/data/UNet_waterline')
    parser.add_argument('--wandb_path', type=str, default='/data/UNet_waterline/wandb', help='path of saving wandb files locally')
    parser.add_argument('--wandb_name', type=str, default='UNet_waterline',
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path  = "/data/UNet_waterline/U-Net/weights/best_epoch_weights_ep070_mIoU0.628.pth"
    #-----------------------------------------------------#
